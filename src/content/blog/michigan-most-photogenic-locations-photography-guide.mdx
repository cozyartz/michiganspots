...
<div class="prose max-w-none">
    ...
    <div class="bg-parchment-dark treasure-border border-2 rounded-lg p-5 my-6">
      ...
      <p class="text-sm text-ink-secondary mb-3">Serious about landscape photography? A <AmazonAffiliateLink asin="B07QD6HQ4V" text="smartphone camera lens kit" /> transforms your phone into a professional tool. Wide-angle lenses capture expansive vistas, while macro lenses reveal intricate details in nature.</p>
      <p class="text-xs text-ink-secondary italic mt-2">Long exposures are key for smooth waterfall shots. A sturdy <AmazonAffiliateLink asin="B075DHSG77" text="portable tripod" /> is essential—especially for low-light sunrise/sunset photography!</p>
    </div>
    ...
    <div class="bg-gold/10 border-l-4 border-gold pl-4 py-3 my-6">
      ...
      <p class="text-sm text-ink-secondary">Location scouting is crucial! The <AmazonAffiliateLink asin="B08KGLVH6L" text="Moon Michigan Travel Guide" /> includes detailed maps, GPS coordinates, and seasonal timing tips for Michigan's most photogenic locations.</p>
    </div>
    ...
    <div class="bg-lakes-blue/10 border-2 border-lakes-blue/30 rounded-lg p-4 my-6">
      ...
      <p class="text-sm text-ink-secondary">Michigan weather changes fast—especially near the Great Lakes! A quality <AmazonAffiliateLink asin="B00H192IPE" text="Columbia rain jacket" /> keeps you and your gear dry during unexpected showers. Waterproof bags are essential for beach/waterfall photography!</p>
    </div>
